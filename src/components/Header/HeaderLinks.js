...
import styles from "assets/jss/fsm-frontend/components/headerLinksStyle.js";
...
export default function HeaderLinks(props) {
  ...
  return (
    <List className={classes.list + " " + classes.mlAuto}>
      <ListItem className={classes.listItem}>
        <CustomDropdown
          ...
          dropdownList={[
            ...
            <a
              href="https://demos.creative-tim.com/fsm-frontend/#/documentation/tutorial?ref=mkpr-navbar"
              target="_blank"
      ...
      <ListItem className={classes.listItem}>
        <Button
          href="https://www.creative-tim.com/product/fsm-frontend?ref=mkpr-navbar"
